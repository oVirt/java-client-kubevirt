 ...
 */
@ApiModel(description = "Represents a cloud-init nocloud user data source. More info: http://cloudinit.readthedocs.io/en/latest/topics/datasources/nocloud.html")
@javax.annotation.Generated(value = "io.swagger.codegen.languages.JavaClientCodegen", date = "2019-11-10T14:44:51.030+02:00")
public class V1CloudInitNoCloudSource {
  ...
  public V1CloudInitNoCloudSource networkData(String networkData) {
   ...
   * @return networkData
  **/
  @ApiModelProperty(value = "NetworkData contains NoCloud inline cloud-init networkdata. + optional")
  ...
  public V1CloudInitNoCloudSource networkDataBase64(String networkDataBase64) {
  ...
  **/
  @ApiModelProperty(value = "NetworkDataBase64 contains NoCloud cloud-init networkdata as a base64 encoded string. + optional")
  ...
  public V1CloudInitNoCloudSource networkDataSecretRef(V1LocalObjectReference networkDataSecretRef) {
  ...
  **/
  @ApiModelProperty(value = "NetworkDataSecretRef references a k8s secret that contains NoCloud networkdata. + optional")
  ...
  public V1CloudInitNoCloudSource secretRef(V1LocalObjectReference secretRef) {
   ...
   * @return secretRef
  **/
  @ApiModelProperty(value = "UserDataSecretRef references a k8s secret that contains NoCloud userdata. + optional")
  ...
  public V1CloudInitNoCloudSource userData(String userData) {
   ...
   * @return userData
  **/
  @ApiModelProperty(value = "UserData contains NoCloud inline cloud-init userdata. + optional")
  ...
  public V1CloudInitNoCloudSource userDataBase64(String userDataBase64) {
  ...
  **/
  @ApiModelProperty(value = "UserDataBase64 contains NoCloud cloud-init userdata as a base64 encoded string. + optional")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    V1CloudInitNoCloudSource v1CloudInitNoCloudSource = (V1CloudInitNoCloudSource) o;
    return Objects.equals(this.networkData, v1CloudInitNoCloudSource.networkData) &&
        Objects.equals(this.networkDataBase64, v1CloudInitNoCloudSource.networkDataBase64) &&
        Objects.equals(this.networkDataSecretRef, v1CloudInitNoCloudSource.networkDataSecretRef) &&
        Objects.equals(this.secretRef, v1CloudInitNoCloudSource.secretRef) &&
        Objects.equals(this.userData, v1CloudInitNoCloudSource.userData) &&
        Objects.equals(this.userDataBase64, v1CloudInitNoCloudSource.userDataBase64);
  }
  ...
  public String toString() {
    ...
    sb.append("class V1CloudInitNoCloudSource {\n");
