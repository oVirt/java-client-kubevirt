...
import kubevirt.io.V1Initializers;
import kubevirt.io.V1OwnerReference;
...
public class V1ObjectMeta {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(annotations, clusterName, deletionGracePeriodSeconds, deletionTimestamp, finalizers, generateName, generation, initializers, labels, name, namespace, ownerReferences, resourceVersion, selfLink, uid);
  }
