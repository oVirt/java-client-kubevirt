...
public class V1PITTimer {
  ...
  public V1PITTimer present(Boolean present) {
  ...
  **/
  ...
  public V1PITTimer tickPolicy(String tickPolicy) {
   ...
   * @return tickPolicy
  **/
  @ApiModelProperty(value = "TickPolicy determines what happens when QEMU misses a deadline for injecting a tick to the guest. One of \"delay\", \"catchup\", \"discard\".")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    V1PITTimer v1PITTimer = (V1PITTimer) o;
    return Objects.equals(this.present, v1PITTimer.present) &&
        Objects.equals(this.tickPolicy, v1PITTimer.tickPolicy);
  }
